...
export const createApp = () => {
    ...
    const taskController = new TaskController(new CreateTask(taskRepository), new ListTasks(taskRepository), new GetTask(taskRepository), new UpdateTask(taskRepository), new DeleteTask(taskRepository));
