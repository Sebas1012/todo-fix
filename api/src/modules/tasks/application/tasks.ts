...
export class CreateTask {
  ...
  async execute(userId: string, input: { title: string; category: TaskCategory; priority: TaskPriority; completed?: boolean }): Promise<Task> {
...
export class ListTasks {
  ...
  execute(userId: string, input: { completed?: boolean; page: number; limit: number }) {
...
export class UpdateTask {
  ...
  async execute(userId: string, id: string, input: { title?: string; category?: TaskCategory; priority?: TaskPriority; completed?: boolean }): Promise<Task> {
